...
const FAQs = () => {
  return (
    <>
      <div className="text-left xl:ml-32 xl:mr-32">
        <div className="space-y-4 p-6">
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <p className="mt-4 px-4 leading-relaxed text-gray-700">
              College Shodh is a college search platform designed to help
              students discover and compare the best colleges across various
              fields in India. It provides detailed information on courses,
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <p className="mt-4 px-4 leading-relaxed text-gray-700">
              Yes, College Shodh is free for all users. You can search and
              explore college details without any charges.
            </p>
          </details>
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <p className="mt-4 px-4 leading-relaxed text-gray-700">
              ...
              including phone numbers, email addresses, and official websites.
              You can reach out to the college directly for more specific
              queries.
            </p>
          </details>
